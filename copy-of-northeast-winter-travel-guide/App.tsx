...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen pb-20 bg-slate-50">
      {/* Hero Header */}
      <header className="relative h-[40vh] md:h-[45vh] flex items-center justify-center overflow-hidden bg-slate-900 text-white transition-all duration-300">
      ...
      {/* 调整了 margin-top，手机上 -mt-8，电脑上 -mt-16，避免遮挡 */}
      <main className="max-w-4xl mx-auto px-4 -mt-8 md:-mt-16 relative z-20">
        
        {/* Navigation Tabs */}
        {/* 修复：使用 overflow-x-auto 和 justify-start 确保手机上可以滑动且不被切掉 */}
