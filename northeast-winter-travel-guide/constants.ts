    ...
    harbin: {
      ...
      items: [
        ...
        },
        {
          ...
          detailContent: '详细攻略：\n1. 交通：哈尔滨西站出来可以直接坐地铁3号线到“中华巴洛克”附近，或者直接打车（约30-40元）。\n2. 晚餐推荐：\n- 张包铺：百年老店，排骨包子必点，但人很多。\n- 老仁义：清真菜，锅包肉（老式）很地道。\n3. 注意：晚上老道外拍照非常有感觉，建议带大光圈镜头。',
          locationKeyword: '中华巴洛克风情街',
          type: 'itinerary',
        ...
        },
        {
          ...
          title: 'Day 3: 冰雪大世界',
          time: '2月9日 (周一)',
          content: '12:30 前往【冰雪大世界】。白天看雪雕，下午排大滑梯/摩天轮。\n16:00 园区开灯，拍摄绝美蓝调时刻（务必贴好暖宝宝）。\n18:30 晚餐：铁锅炖大鹅或铜锅涮肉。',
          locationKeyword: '哈尔滨冰雪大世界',
          tags: ['重点行程', '保暖'],
          type: 'activity',
    ...
    qiqihar: {
      ...
      items: [
        ...
        },
        {
          id: 'q-crane',
          title: '必做：扎龙观鹤',
          content: '前往扎龙自然保护区看丹顶鹤雪地放飞。\n提示：旷野风极大，体感温度比市区低10度，务必穿上最厚的装备。',
          locationKeyword: '扎龙生态旅游区',
          tags: ['景点', '视觉震撼'],
          type: 'activity',
