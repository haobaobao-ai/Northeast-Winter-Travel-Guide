    ...
    items: [
      {
        ...
        tags: ['已完成', '交通'],
        type: 'alert',
        imageUrl: 'https://images.unsplash.com/photo-1531642765602-5cae8bbbf285?auto=format&fit=crop&w=800&q=80'
      }
    ]
  },
  harbin: {
    ...
    items: [
      ...
      },
      {
        ...
        type: 'itinerary',
        imageUrl: 'https://images.unsplash.com/photo-1612450630325-a6e5b2259648?auto=format&fit=crop&w=800&q=80'
      },
      {
        id: 'h-d3',
        title: 'Day 3: 冰雪大世界',
        ...
        tags: ['重点行程', '保暖'],
        type: 'activity',
        imageUrl: 'https://images.unsplash.com/photo-1548236209-408a0d990422?auto=format&fit=crop&w=800&q=80'
      },
       {
        id: 'h-d4',
        title: 'Day 4: 转战鹤城',
        ...
        type: 'itinerary',
        imageUrl: 'https://images.unsplash.com/photo-1474487548417-781cb714c2f3?auto=format&fit=crop&w=800&q=80'
      }
    ]
  },
  qiqihar: {
    ...
    items: [
      ...
      },
      {
        ...
        tags: ['景点', '视觉震撼'],
        type: 'activity',
        imageUrl: 'https://images.unsplash.com/photo-1490079027102-cd2612b70ca4?auto=format&fit=crop&w=800&q=80'
      },
      {
        id: 'q-other',
        title: '休闲漫步',
        ...
        type: 'itinerary',
        imageUrl: 'https://images.unsplash.com/photo-1480497490787-505ec076689f?auto=format&fit=crop&w=800&q=80'
      }
    ]
  },
  tips: {
    ...
    items: [
      {
        ...
        tags: ['数码', '紧急'],
        type: 'alert',
        imageUrl: 'https://images.unsplash.com/photo-1512428559087-560fa5ce7d02?auto=format&fit=crop&w=800&q=80'
      },
      {
        id: 't-gear',
        title: '衣物穿搭公式',
